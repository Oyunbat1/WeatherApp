...
const Dark = function(){
    ...
    <div className="z-10 w-[450px] h-[660px] flex justify-center items-center relative mb-[100px] mt-[140px]">
      <img src="moonbottom.svg" className="absolute bottom-[0px] left-[330px]"></img>
        ...
        <div className="mr-[60px]">
          <h1 className="text-[80px] font-bold bg-gradient-to-b from-gray-50 to-transparent bg-clip-text text-transparent">-26.7°</h1>
